...
def apply_category_adjustment(
    ...
    adjustments = {
        "Chocolate & Confectionery": {
            "penalty": -2,
            "message": "Confectionery products are best enjoyed occasionally."
        },
        "Chips & Fried Snacks": {
            "penalty": -1.5,
            "message": "Fried snacks can be energy dense."
        },
        "Instant Noodles": {
            "penalty": -2,
            "message": "Instant noodles are often high in sodium and refined flour."
        },
        "Biscuits & Cookies": {
            "penalty": -1,
            "message": "Biscuits are often high in refined flour and sugar."
        },
        "Soft Drinks": {
            "penalty": -3,
            "message": "Soft drinks can contribute significant added sugar."
        },
        "Makhana Snacks": {
            "penalty": 0,
            "message": "Makhana-based snacks are generally better options."
        },
        "Protein/Nut Snacks": {
            "penalty": 0,
            "message": "Nut and legume snacks can provide protein and satiety."
        }
    }
...
def analyze_ingredients(text):
    ...
    harmful_map = {
        "PALMOLEIN": {
            "name": "Refined Palmolein",
            "penalty": 2,
            "note": "Refined oil high in saturated fat.",
            "advisory": {
                "title": "High Saturated Fat Intake",
                "severity": "Moderate Risk",
                "detail": "Frequent intake of refined oils may negatively affect cardiovascular health."
            }
        },
        "PALM OIL": {
            "name": "Palm Oil",
            "penalty": 2,
            "note": "Highly processed oil."
        },
        "MALTODEXTRIN": {
            "name": "Maltodextrin",
            "penalty": 1,
        ...
        "SUGAR": {
            "name": "Added Sugar",
            "penalty": 1,
            "note": "Frequent intake may affect metabolic health.",
            "advisory": {
                "title": "Excess Sugar Intake",
                "severity": "Moderate Risk",
                "detail": "Frequent consumption of added sugars may contribute to poor metabolic health."
            }
        },
        "MAIDA": {
            "name": "Refined Wheat Flour (Maida)",
            "penalty": 1,
            "note": "Low fibre refined flour."
        },
        "HYDROGENATED": {
            "name": "Hydrogenated Fat",
            "penalty": 2,
            "note": "Possible source of trans fats."
        },
        "HYDROLYZED VEGETABLE PROTEIN": {
            "name": "Hydrolyzed Vegetable Protein",
            "penalty": 0.5,
            "note": "Highly processed flavouring ingredient."
        },
        "NATURE IDENTICAL": {
            "name": "Nature Identical Flavours",
            "penalty": 0.5,
            "note": "Synthetic flavour compounds."
        }
    }
    ...
    "TOMATO POWDER " or "TOMATO powder": "Processed tomato ingredient.",
    ...
    for ingredient, note in processed_natural_map.items():
        ...
        if ingredient in text:
            ...
            processed_natural.append({
            "name": ingredient.title(),
            "note": note
        })
    safe_map = {
        "POTATO": "Whole vegetable ingredient.",
        "ONION": "Natural spice.",
        "GARLIC": "Natural spice.",
        "TOMATO": "Natural ingredient.",
        "PEANUT": "Protein-rich ingredient.",
        "CHICKPEA": "Good source of fibre and protein.",
        "CUMIN": "Natural spice.",
        "CORIANDER": "Natural spice.",
        "TURMERIC": "Traditional spice.",
        "MAKHANA": "Roasted lotus seeds; naturally nutritious.",
        "FOX SEEDS": "Nutritious seeds.",
        "OLIVE OIL": "Healthier fat source.",
        "PARSLEY": "Natural herb.",
        "CHILLI": "Natural spice.",
        "ONION": "Natural spice.",
        "GARLIC": "Natural spice.",
        "PEANUT": "Protein-rich ingredient.",
        "POTATO": "Whole vegetable ingredient.",
        "OATS": "Rich in soluble fibre.",
"MILLETS": "Traditional whole grains.",
"RAGI": "Calcium-rich millet.",
"JOWAR": "Whole grain.",
"BAJRA": "Fibre-rich millet.",
"ALMOND": "Healthy fats and protein.",
"CASHEW": "Nutritious nut source.",
"WALNUT": "Omega-3 source.",
"HONEY": "Natural sweetener.",
"JAGGERY": "Traditional sweetener."
}
...
async def analyze(label_image: UploadFile = File(...)):
    ...
    score, harmful, additives, safe, processed_natural, advisories, score_breakdown = analyze_ingredients(
    extracted_text
)

    score = apply_category_adjustment(
        score,
        category,
        advisories,
        score_breakdown
